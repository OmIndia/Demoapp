...
//$query="";
//$link = mysqli_connect("localhost","root","hariom","test");                 //Om - Jun 13 2018 - put inside while loop below so mysql connection is closed each time
...
$conn = stream_socket_server('tcp://afternoon-dawn-44153.herokuapp.com:80'); 
...
//mysqli_close($link);     //Om - moved into while loop above - 13 Jun 2018
?>